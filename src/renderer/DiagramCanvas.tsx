...
export function DiagramCanvas({
  ...
  const [liveNodes, setLiveNodes] = useState<Node[]>(positionedNodes);
  ...
  const nodes = useMemo<Node[]>(
    ...
    [highlightedNodeIds, isFocusView, liveNodes]
  );
  ...
  const handleNodeDragStop = useCallback(
    (_event: MouseEvent | TouchEvent, node: Node) => {
      ...
      setLiveNodes(applyCustomLayout(flow.nodes, nextLayout));
